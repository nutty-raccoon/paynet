use crate::abis::{IERC20_CONTRACT_ABI, INVOICE_CONTRACT_ABI};
use crate::types::{
    ConctractData, DepositData, DepositTemplate, InvalidMethodTemplate, InvalidNetworkTemplate,
    InvalidPayloadTemplate, RouteParams, SaltoLandingTemplate,
};
use askama::Template;
use axum::{
    extract::{Path, Query},
