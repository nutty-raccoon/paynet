...
mod tests {
    ...
    fn test_asset_from_str() {
        ...
        assert_eq!(Asset::from_str("btc").unwrap(), Asset::WBtc);
    ...
    fn test_asset_find_best_unit() {
        ...
        assert_eq!(Asset::Usdc.find_best_unit(), Unit::CentUsd);
        assert_eq!(Asset::Usdt.find_best_unit(), Unit::CentUsd);
    }
